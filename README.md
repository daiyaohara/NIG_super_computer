...
### 20210612追記  
・最近、NIGのスーパーコンピュータは混雑している。当然要求した分のメモリが残っていないと永遠にJobは投入されない。  
・各ノードのメモリ残量を確認する。それ以下であれば、すぐに通る。  
$ qstat -F | grep hl:m_mem_free  、  
...
#### 仮想環境構築
$ ./conda create -n infinityflow  #/home/user_name/miniconda3/envs/ENV_NAMEに仮想環境が作られる  
$ cd miniconda3/bin  
